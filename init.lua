...
require('lazy').setup({
  ...
  -- Autocompletion
  {
    ...
    dependencies = {
      ...
      'L3MON4D3/LuaSnip',
      -- LuaSnip's snippet completion source
      'saadparwaiz1/cmp_luasnip',

      -- nvim-cmp's completion source
      'hrsh7th/cmp-nvim-lsp',
      -- nvim-cmp's completiont source for filesystem paths
      'hrsh7th/cmp-path',

      -- Adds snippets for all languages contributed from the community
...
vim.keymap.set('n', '<leader>G', ':LiveGrepGitRoot<cr>', { desc = '[S]earch by [G]rep on Git Root' })
...
cmp.setup {
  ...
  mapping = cmp.mapping.preset.insert {
    ...
    -- Commenting out due to collision with Copilot's tab
